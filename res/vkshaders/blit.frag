...
layout(set = 1, binding = 5) uniform sampler2D deferred_dummy0;
layout(set = 1, binding = 6) uniform sampler2D deferred_dummy1;
layout(set = 1, binding = 7) uniform sampler2D deferred_depth;
